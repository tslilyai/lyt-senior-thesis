...
\noindent\fbox{\begin{minipage}{\textwidth}
   Conclusion: T-Queue2 outperforms T-Queue1, indicating that a pessimistic approach is more appropriate for contentious operations.
\end{minipage}}
