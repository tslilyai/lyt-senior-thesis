...
\\
    \hline
\end{tabular}
    \caption[Dependencies generated by singleton transactions that require synchronization.]{Dependencies generated by singleton transactions that require synchronization.
...
\subsection{Invalid Dependency Cycles in Transactional Queues}
\label{dep_cycles}
...
\\
    \hline
\end{tabular}
    \caption[Invalid dependency cycles in a transactional setting.]{Invalid dependency cycles in a transactional setting. 
