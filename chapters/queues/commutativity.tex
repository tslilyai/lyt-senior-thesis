...
\begin{eg}
$H$ is a serializable but not linearizable history. $H'$ is a valid serial ordering, but violates the rule that the serial order of transactions corresponds to the real time at which the transactions committed.
