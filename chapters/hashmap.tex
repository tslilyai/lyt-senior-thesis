...
\begin{figure}[h!]
    ...
    \begin{tabular}{|cc|}
        ...
        \includegraphics[height=2.5in]{maps/5HM1M:F34,I33,E33speed.png} &
        \includegraphics[height=2.5in]{maps/5HM1M:F34,I33,E33aborts.png}\\
        \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 20}\\
        \includegraphics[height=2.5in]{maps/20HM1M:F34,I33,E33speed.png} &
    \includegraphics[height=2.5in]{maps/20HM1M:F34,I33,E33aborts.png}\\
    \hline 
    \end{tabular}
    %\includegraphics[height=2.5in]{maps/10HM1M:F34,I33,E33speed.png}
    %\includegraphics[height=2.5in]{maps/15HM1M:F34,I33,E33speed.png}
    %\includegraphics[height=2.5in]{maps/10HM1M:F34,I33,E33aborts.png}
    %\includegraphics[height=2.5in]{maps/15HM1M:F34,I33,E33aborts.png}
    %\includegraphics[height=2.5in]{maps/10HM1M:F90,I5,E5speed.png}
    %\includegraphics[height=2.5in]{maps/15HM1M:F90,I5,E5speed.png}
    %\includegraphics[height=2.5in]{maps/10HM1M:F90,I5,E5aborts.png}
    %\includegraphics[height=2.5in]{maps/15HM1M:F90,I5,E5aborts.png}
\label{fig:ntqueues}
\end{figure}
\begin{figure}[h!]
    \centering
    ...
    \begin{tabular}{|cc|}
        ...
        \hline \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 5}\\
        \includegraphics[height=2.5in]{maps/5HM125K:F34,I33,E33speed.png} &
        \includegraphics[height=2.5in]{maps/5HM125K:F34,I33,E33aborts.png}\\
        \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 20}\\
        \includegraphics[height=2.5in]{maps/20HM125K:F34,I33,E33speed.png} &
    \includegraphics[height=2.5in]{maps/20HM125K:F34,I33,E33aborts.png}\\
    \hline 
    \end{tabular}
    %\includegraphics[height=2.5in]{maps/10HM125K:F34,I33,E33speed.png}
    %\includegraphics[height=2.5in]{maps/15HM125K:F34,I33,E33speed.png}
    %\includegraphics[height=2.5in]{maps/10HM125K:F34,I33,E33aborts.png}
    %\includegraphics[height=2.5in]{maps/15HM125K:F34,I33,E33aborts.png}
    %\includegraphics[height=2.5in]{maps/10HM125K:F90,I5,E5speed.png}
    %\includegraphics[height=2.5in]{maps/15HM125K:F90,I5,E5speed.png}
    %\includegraphics[height=2.5in]{maps/10HM125K:F90,I5,E5aborts.png}
    %\includegraphics[height=2.5in]{maps/15HM125K:F90,I5,E5aborts.png}
\label{fig:ntqueues}
\end{figure}
\begin{figure}[h!]
    \centering
    ...
    \begin{tabular}{|cc|}
        ...
        \hline \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 5}\\
        \includegraphics[height=2.5in]{maps/5HM10K:F34,I33,E33speed.png} &
        \includegraphics[height=2.5in]{maps/5HM10K:F34,I33,E33aborts.png}\\
        \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 20}\\
        \includegraphics[height=2.5in]{maps/20HM10K:F34,I33,E33speed.png} &
    \includegraphics[height=2.5in]{maps/20HM10K:F34,I33,E33aborts.png}\\
    \hline 
    \end{tabular}
    %\includegraphics[height=2.5in]{maps/10HM10K:F34,I33,E33speed.png}
    %\includegraphics[height=2.5in]{maps/15HM10K:F34,I33,E33speed.png}
    %\includegraphics[height=2.5in]{maps/10HM10K:F34,I33,E33aborts.png}
    %\includegraphics[height=2.5in]{maps/15HM10K:F34,I33,E33aborts.png}
    %\includegraphics[height=2.5in]{maps/10HM10K:F90,I5,E5speed.png}
    %\includegraphics[height=2.5in]{maps/15HM10K:F90,I5,E5speed.png}
    %\includegraphics[height=2.5in]{maps/10HM10K:F90,I5,E5aborts.png}
    %\includegraphics[height=2.5in]{maps/15HM10K:F90,I5,E5aborts.png}
\label{fig:ntqueues}
\end{figure}
\begin{figure}[h!]
    \centering
    ...
    \begin{tabular}{|cc|}
        ...
        \hline \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 5}\\
        \includegraphics[height=2.5in]{maps/5HM1M:F90,I5,E5speed.png} &
        \includegraphics[height=2.5in]{maps/5HM1M:F90,I5,E5aborts.png}\\
        \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 20}\\
        \includegraphics[height=2.5in]{maps/20HM1M:F90,I5,E5speed.png} &
    \includegraphics[height=2.5in]{maps/20HM1M:F90,I5,E5aborts.png}\\
    \hline 
    \end{tabular}
    %\includegraphics[height=2.5in]{maps/10HM1M:F90,I5,E5speed.png}
    %\includegraphics[height=2.5in]{maps/15HM1M:F90,I5,E5speed.png}
...
\begin{figure}[h!]
    ...
    \begin{tabular}{|cc|}
        ...
        \hline \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 5}\\
        \includegraphics[height=2.5in]{maps/5HM125K:F90,I5,E5speed.png} &
        \includegraphics[height=2.5in]{maps/5HM125K:F90,I5,E5aborts.png}\\
        \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 20}\\
        \includegraphics[height=2.5in]{maps/20HM125K:F90,I5,E5speed.png} &
    \includegraphics[height=2.5in]{maps/20HM125K:F90,I5,E5aborts.png}\\
    \hline 
    \end{tabular}
    %\includegraphics[height=2.5in]{maps/10HM125K:F90,I5,E5speed.png}
    %\includegraphics[height=2.5in]{maps/15HM125K:F90,I5,E5speed.png}
...
\begin{figure}[h!]
    ...
    \begin{tabular}{|cc|}
        ...
        \hline \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 5}\\
        \includegraphics[height=2.5in]{maps/5HM10K:F90,I5,E5speed.png} &
        \includegraphics[height=2.5in]{maps/5HM10K:F90,I5,E5aborts.png}\\
        \hline &\\
        \multicolumn{2}{|c|}{Maximum Load: 20}\\
        \includegraphics[height=2.5in]{maps/20HM10K:F90,I5,E5speed.png} &
    \includegraphics[height=2.5in]{maps/20HM10K:F90,I5,E5aborts.png}\\
    \hline 
    \end{tabular}
    %\includegraphics[height=2.5in]{maps/10HM10K:F90,I5,E5speed.png}
    %\includegraphics[height=2.5in]{maps/15HM10K:F90,I5,E5speed.png}
