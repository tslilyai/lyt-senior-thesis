...
\subsubsection{Test}
\paragraph{Multi-Thread, Variable-Capacity Singletons Test} 
...
The test is run twice, once with a probability of 33\% insert, 33\% delete, and 34\% find, and again with a probability of 5\% insert, 5\% delete, and 90\% find. The steady-state final size is 50\% capacity.
