...
\begin{table}[t]
    ...
    \begin{tabular}{|l|c|}
        ...
        \hline
\begin{lstlisting}
(T1, M.find(k,v), true/false) 
(T2, M.find(k,v), true/false)
\end{lstlisting} &
       \\ 
    \hline
\begin{lstlisting}
...
W$_1$-R$_2$
    ...
    \hline
\begin{lstlisting}
(T1, M.insert(k,v), true/false) 
(T2, M.erase(k), true/false)
\end{lstlisting} &
W$_1$-R$_2$, R$_1$-W$_2$, W$_1$-W$_2$
       \\ 
    \hline
\begin{lstlisting}
(T1, M.erase(k), true) 
...
W$_1$-R$_2$
    ...
    \hline
\begin{lstlisting}
(T1, M.erase(k), true/false) 
(T2, M.insert(k,v), true/false)
\end{lstlisting} &
W$_1$-R$_2$, R$_1$-W$_2$, W$_1$-W$_2$
       \\ 
    \hline
\end{tabular}
    \caption[Hashmap dependencies generated by singleton transactions that require synchronization.]{Hashmap dependencies generated by singleton transactions that require synchronization.

    A write of the bucket \texttt{b} occurs only if the operation successfully adds or removes an element from the bucket; we show only those specific scenarios in which writes occur and generate dependencies that require synchronization. R-R dependencies are omitted because they do not require synchronization.
}
    \label{tab:hmsimpledeps}
\end{table}
